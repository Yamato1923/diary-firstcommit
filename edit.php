...
// =============================  データを更新する  ============================
    $sql = 'UPDATE `writing` SET `date` = ?, `text` = ?, `img_name` = ? WHERE `id` = ?';
    $data = [$date, $text, $submit_file_name];
    $data[] = $_GET['id'];
            ...
            <!-- ここから -->
                <div class="col-xs-8 col-xs-offset-2 thumbnail">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div style="float: left; margin-left: 50px;"><input type="button" class="btn btn-primary" onclick="history.back()" value="戻る"></div>
                        <div style="float: right; margin-right: 50px;"><input type="submit" class="btn btn-success" value="投稿する"></div>
                    </form>
                </div>
            </div>
